...
class Container_037433242b extends _PHPStan_e870ac104\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0381(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_037433242b $container)
			{
	...
	public function createServiceContainer(): Container_037433242b
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'env' => [
				...
				'PHP_INI_SCAN_DIR' => '',
				'PHPRC' => '/private/var/folders/w_/_l8__bv90pjgn5j9h7jd8jr00000gn/T/jfvfbp5rejkcdBdumeq',
				'XDEBUG_HANDLER_SETTINGS' => '/private/var/folders/w_/_l8__bv90pjgn5j9h7jd8jr00000gn/T/jfvfbp5rejkcdBdumeq|1|*|*|/opt/homebrew/etc/php/8.4/php.ini:/opt/homebrew/etc/php/8.4/conf.d/ext-opcache.ini|3.4.5',
			],
		];
	}
