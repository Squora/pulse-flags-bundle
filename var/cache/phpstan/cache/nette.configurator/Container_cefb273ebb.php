...
class Container_cefb273ebb extends _PHPStan_e870ac104\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService04(): PHPStan\File\FileExcluderFactory
	{
		return new PHPStan\File\FileExcluderFactory(
			...
			['analyseAndScan' => ['/Users/nskvorcov/Projects/pulse-flags-bundle/tests'], 'analyse' => []]
		);
	}
	...
	{
		return new PHPStan\Analyser\Ignore\IgnoredErrorHelper($this->getService('05'), ['#Access to an undefined property#'], true);
	}
	...
	public function createService0381(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_cefb273ebb $container)
			{
	...
	public function createServiceContainer(): Container_cefb273ebb
	{
		return $this;
	}
	...
	{
		return new PHPStan\Symfony\XmlParameterMapFactory('/Users/nskvorcov/Projects/pulse-flags-bundle/var/cache/dev/App_KernelDevDebugContainer.xml');
	}


	public function createServiceSymfony__serviceMapFactory(): PHPStan\Symfony\ServiceMapFactory
	{
		return new PHPStan\Symfony\XmlServiceMapFactory('/Users/nskvorcov/Projects/pulse-flags-bundle/var/cache/dev/App_KernelDevDebugContainer.xml');
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'excludePaths' => ['analyseAndScan' => ['/Users/nskvorcov/Projects/pulse-flags-bundle/tests'], 'analyse' => []],
			'level' => 8,
			...
			'ignoreErrors' => ['#Access to an undefined property#'],
			...
			'symfony' => [
				'containerXmlPath' => '/Users/nskvorcov/Projects/pulse-flags-bundle/var/cache/dev/App_KernelDevDebugContainer.xml',
			...
			'env' => [
				...
				'PHP_INI_SCAN_DIR' => '',
				'PHPRC' => '/private/var/folders/w_/_l8__bv90pjgn5j9h7jd8jr00000gn/T/28c3o1snq8120xRazlj',
				'XDEBUG_HANDLER_SETTINGS' => '/private/var/folders/w_/_l8__bv90pjgn5j9h7jd8jr00000gn/T/28c3o1snq8120xRazlj|1|*|*|/opt/homebrew/etc/php/8.4/php.ini:/opt/homebrew/etc/php/8.4/conf.d/ext-opcache.ini|3.4.5',
			],
		];
	}
