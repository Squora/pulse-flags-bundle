...
class Container_b78d28b459 extends _PHPStan_e870ac104\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService061(): PHPStan\Analyser\Ignore\IgnoredErrorHelper
	{
		return new PHPStan\Analyser\Ignore\IgnoredErrorHelper(
			...
			[
				...
				'#Cannot cast .* to string.*PulseFlagsExtension#',
			],
			true
		);
	}
	...
	public function createService0381(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_b78d28b459 $container)
			{
	...
	public function createServiceContainer(): Container_b78d28b459
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'env' => [
				...
				'PHP_INI_SCAN_DIR' => '',
				'PHPRC' => '/private/var/folders/w_/_l8__bv90pjgn5j9h7jd8jr00000gn/T/h1t010ifpam78RnN6Ha',
				'XDEBUG_HANDLER_SETTINGS' => '/private/var/folders/w_/_l8__bv90pjgn5j9h7jd8jr00000gn/T/h1t010ifpam78RnN6Ha|1|*|*|/opt/homebrew/etc/php/8.4/php.ini:/opt/homebrew/etc/php/8.4/conf.d/ext-opcache.ini|3.4.5',
			],
		];
	}
