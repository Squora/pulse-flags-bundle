...
class Container_3c1b0f834f extends _PHPStan_e870ac104\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0381(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_3c1b0f834f $container)
			{
	...
	public function createServiceContainer(): Container_3c1b0f834f
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'env' => [
				...
				'PHP_INI_SCAN_DIR' => '',
				'PHPRC' => '/private/var/folders/w_/_l8__bv90pjgn5j9h7jd8jr00000gn/T/pks5kjpbun0geICbn3e',
				'XDEBUG_HANDLER_SETTINGS' => '/private/var/folders/w_/_l8__bv90pjgn5j9h7jd8jr00000gn/T/pks5kjpbun0geICbn3e|1|*|*|/opt/homebrew/etc/php/8.4/php.ini:/opt/homebrew/etc/php/8.4/conf.d/ext-opcache.ini|3.4.5',
			],
		];
	}
